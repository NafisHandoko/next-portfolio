export const projectsData = [
    ...
    {
        name: 'HaDe',
        description: 'Hade is a website I created during my internship at Bisa.ai. HaDe is an e-commerce website that sells various necessities for building a house such as building materials and construction workers.',
    ...
    {
        name: 'NeuralBot',
        description: 'A ChatGPT clone. This is just a random fun project i made while exploring OpenAI API (the free plan of course). Built using React-Typescript and Tailwindcss for the frontend and Node JS for the backend.',
    ...
    {
        name: 'Cokro Collection Landing Page',
        description: "This is a simple landing page that I built at my friend's request for his father's textile business.",
