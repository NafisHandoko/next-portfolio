...
export default function ProjectsSection() {
    return (
        ...
        >
            <MotionH2 whileInView="show" initial="hidden" variants={textVariantTransition(0)} className="uppercase text-light-nero dark:text-dark-nero font-bold text-3xl">Side Projects</MotionH2>
